...
sentence2 = Or(And(AKnave, BKnave), And(AKnight, BKnight))
sentence21 = Or(And(AKnave, BKnight), And(AKnight, BKnave))
knowledge2 = And(
    Or(AKnight, AKnave),
    Or(BKnight, BKnave),
    Or(CKnight, CKnave),
    ...
    Biconditional(AKnight, sentence2),
    Biconditional(BKnight, sentence21),
)
...
sentenceB = And(Biconditional(AKnight, BKnight), CKnave)
sentenceC = AKnight
knowledge3 = And(
    Or(AKnight, AKnave),
    Or(BKnight, BKnave),
